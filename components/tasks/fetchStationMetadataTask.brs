...
Function GetJSONAtUrl(url as String)
    if NOT m.DoesExist("jsontransfer") then
        ...
        m.jsontransfer = Request
        response = Request.GetToString()
        
        m.Delete("jsontransfer")
...
Function HandleJSON(jsonString as String)
    ...
    ' song.backgroundimage = station.image
    ' song.artistimage = station.image
    ...
    ' end if
        ...
        'print "There was an error processing or downloading metadata: " + song.feedurl, "error"
